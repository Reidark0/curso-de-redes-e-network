export const lesson1006 = {
  "id": "10.6",
  "moduleId": "m10",
  "order": 6,
  "title": "Split tunnel, full tunnel e DNS em VPN",
  "subtitle": "Por que a VPN conecta, mas nomes não resolvem, tráfego sai pelo caminho errado ou aplicações internas falham.",
  "duration": "70-100 min",
  ...
  "learningOutcomes": [
    "Dado um cenário envolvendo split tunnel, full tunnel, DNS interno, DNS público, rotas específicas, proxy, vazamento DNS e experiência do usuário, o aluno identifica requisitos, riscos e evidências.",
  ...
  "content": {
    ...
    "summary": "<ul><li><strong>Ideia central:</strong> Split tunnel envia apenas destinos definidos pelo túnel, full tunnel envia todo o tráfego pela VPN, e DNS decide se o cliente encontra os nomes internos corretos.</li><li><strong>O que lembrar:</strong> conectividade não é autorização.</li><li><strong>Erro comum:</strong> tratar VPN como segurança automática.</li><li><strong>Uso real:</strong> home office, filiais, cloud híbrida, fornecedores e administração segura.</li></ul>\n<div class=\"evidence-box\"><strong>Resumo da revisão técnica fina:</strong> Validação técnica fina: split tunnel, full tunnel e DNS sem vazamento operacional. O domínio da aula exige explicar split tunnel, forced/full tunnel, split DNS, DNS leak, NRPT/perfil de nome, custos e privacidade, validar por logs e comandos, e justificar trade-offs de segurança, operação e custo.</div>",
    "nextTheme": "<p>A próxima aula mostra por que muitas organizações migraram parte desse modelo para Zero Trust, ZTNA e SASE.</p>"
  },
  "networkContext": {
    "osiLayers": [
      "Camada 3",
  ...
  "troubleshooting": {
    ...
    "commands": [
      ...
      {
        "platform": "Windows",
        "command": "ipconfig /all\nroute print\nResolve-DnsName intranet.empresa.local",
        "purpose": "Ver DNS recebido, rotas e resolução de nome interno.",
        "expectedObservation": "Servidor DNS esperado e rota para a rede privada ou proxy correto.",
        "interpretation": "Nome interno resolvendo publicamente indica split DNS quebrado."
      },
      {
        "platform": "Linux",
        "command": "resolvectl status 2>/dev/null || cat /etc/resolv.conf\nip route\ndig intranet.empresa.local",
        "purpose": "Validar resolvedor, rotas e FQDN interno.",
        "expectedObservation": "Resolvedor e resposta coerentes com o túnel.",
        "interpretation": "Se IP funciona e nome não, foco deve ir para DNS, não firewall."
      }
    ],
    "decisionTree": [
      {
  ...
  "security": {
    ...
    "vulnerabilities": [
      ...
      {
        "name": "Acesso remoto amplo demais em 10.6",
      ...
      {
        "name": "Falha de revogação em 10.6",
  ...
  "lab": {
    "id": "lab-10.6",
    "title": "Diagnóstico conceitual de rotas e DNS em VPN",
    "labType": "security",
    "objective": "Identificar quando um problema é de rota, DNS, proxy ou firewall, usando comandos seguros de observação local.",
    "scenario": "Você atua como analista de infraestrutura e segurança. A empresa precisa lidar com split tunnel, full tunnel, DNS interno, DNS público, rotas específicas, proxy, vazamento DNS e experiência do usuário sem expor recursos internos diretamente na Internet.",
    ...
    "steps": [
      ...
      },
      {
        ...
        "instruction": "Testar resolução por IP e por nome em cenário split/full tunnel, registrando rotas, DNS entregue e risco de vazamento.",
        "command": "# Dossiê M10 10.6\nTema: Split tunnel, full tunnel e DNS em VPN\nFoco: split tunnel | forced/full tunnel | split DNS | DNS leak | NRPT/perfil de nome | custos e privacidade\nEntregável: matriz técnica com decisão, evidência e risco residual",
  ...
  "exercises": [
    ...
    },
    {
      "id": "ex10.6.p1m10.1",
      "type": "diagnóstico",
      "prompt": "Em Split tunnel, full tunnel e DNS em VPN, a sessão aparece como conectada, mas a aplicação falha. Separe hipóteses de plano de controle e plano de dados.",
  ...
  "challenge": {
    "title": "Desafio 10.6: aplicar Split tunnel, full tunnel e DNS em VPN em empresa híbrida",
  ...
  "references": [
    ...
    },
    {
      ...
      "url": "https://learn.microsoft.com/en-us/windows/security/operating-system-security/network-security/vpn/vpn-name-resolution",
      "note": "Referência para explicar resolução de nomes, DNS entregue pela VPN e comportamento de resolução após conexão."
    }
  ],
  "linksToOtherCourses": [
    {
  ...
  "blueTeamDetections": [
    {
      "name": "Acesso remoto anômalo em 10.6",
    ...
    {
      "name": "Tráfego excessivo ou lateral após sessão remota em 10.6",
