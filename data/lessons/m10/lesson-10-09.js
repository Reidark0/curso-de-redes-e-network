export const lesson1009 = {
  "id": "10.9",
  "moduleId": "m10",
  "order": 9,
  "title": "Segurança operacional: MFA, certificados, logs e riscos",
  "subtitle": "Como operar acesso remoto sem transformar a VPN em corredor lateral para incidentes.",
  "duration": "70-100 min",
  ...
  "learningOutcomes": [
    "Dado um cenário envolvendo MFA, certificados, ciclo de vida de credenciais, logs, SIEM, alertas, segmentação, postura e resposta a incidentes, o aluno identifica requisitos, riscos e evidências.",
  ...
  "content": {
    ...
    "summary": "<ul><li><strong>Ideia central:</strong> Segurança operacional de VPN depende de autenticação forte, autorização mínima, certificados bem geridos, logs úteis, detecção, revogação rápida e revisão contínua.</li><li><strong>O que lembrar:</strong> conectividade não é autorização.</li><li><strong>Erro comum:</strong> tratar VPN como segurança automática.</li><li><strong>Uso real:</strong> home office, filiais, cloud híbrida, fornecedores e administração segura.</li></ul>\n<div class=\"evidence-box\"><strong>Resumo da revisão técnica fina:</strong> Validação técnica fina: operação segura, MFA, certificados, logs e revogação. O domínio da aula exige explicar lifecycle de certificados, MFA resistente a phishing, logs de autenticação/autorização, SIEM, revogação, alertas, validar por logs e comandos, e justificar trade-offs de segurança, operação e custo.</div>",
    "nextTheme": "<p>A última aula integra tudo em um projeto: desenhar acesso remoto seguro para empresa híbrida.</p>"
  },
  "networkContext": {
    "osiLayers": [
      "Camada 3",
  ...
  "troubleshooting": {
    ...
    "commands": [
      ...
      {
        "platform": "SIEM",
        "command": "vpn_auth_failure_count by user, source_ip, country, device_id over 15m",
        "purpose": "Detectar força bruta, password spraying ou dispositivo problemático.",
        "expectedObservation": "Alertas por excesso de falhas ou mudança contextual.",
        "interpretation": "O alerta deve disparar resposta proporcional, não bloqueio cego sem análise."
      },
      {
        "platform": "PKI/VPN",
        "command": "inventário: certificado/chave -> dono -> validade -> último uso -> recurso autorizado",
        "purpose": "Controlar credenciais técnicas de acesso remoto.",
        "expectedObservation": "Nenhum certificado sem dono ou validade.",
        "interpretation": "Credencial sem dono é risco operacional e de auditoria."
      }
    ],
    "decisionTree": [
      {
  ...
  "security": {
    ...
    "vulnerabilities": [
      ...
      {
        "name": "Acesso remoto amplo demais em 10.9",
      ...
      {
        "name": "Falha de revogação em 10.9",
  ...
  "exercises": [
    ...
    },
    {
      "id": "ex10.9.p1m10.1",
      "type": "diagnóstico",
      "prompt": "Em Segurança operacional: MFA, certificados, logs e riscos, a sessão aparece como conectada, mas a aplicação falha. Separe hipóteses de plano de controle e plano de dados.",
  ...
  "challenge": {
    "title": "Desafio 10.9: aplicar Segurança operacional: MFA, certificados, logs e riscos em empresa híbrida",
  ...
  "blueTeamDetections": [
    {
      "name": "Acesso remoto anômalo em 10.9",
    ...
    {
      "name": "Tráfego excessivo ou lateral após sessão remota em 10.9",
