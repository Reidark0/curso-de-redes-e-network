export const lesson1004 = {
  "id": "10.4",
  "moduleId": "m10",
  "order": 4,
  "title": "Remote access VPN: usuário fora da rede",
  "subtitle": "Como notebooks, usuários móveis e terceiros entram de forma controlada sem ganhar a rede inteira por acidente.",
  "duration": "70-100 min",
  ...
  "learningOutcomes": [
    "Dado um cenário envolvendo cliente VPN, pool de endereços, autenticação, perfil de acesso, postura do dispositivo, MFA e revogação, o aluno identifica requisitos, riscos e evidências.",
  ...
  "content": {
    ...
    "summary": "<ul><li><strong>Ideia central:</strong> Remote access VPN cria conectividade para um usuário ou dispositivo remoto, geralmente por cliente, perfil, autenticação forte e políticas que limitam recursos acessíveis.</li><li><strong>O que lembrar:</strong> conectividade não é autorização.</li><li><strong>Erro comum:</strong> tratar VPN como segurança automática.</li><li><strong>Uso real:</strong> home office, filiais, cloud híbrida, fornecedores e administração segura.</li></ul>\n<div class=\"evidence-box\"><strong>Resumo da revisão técnica fina:</strong> Validação técnica fina: remote access centrado em usuário, dispositivo e postura. O domínio da aula exige explicar MFA, certificados de usuário/dispositivo, postura do endpoint, user tunnel vs device tunnel, revogação, validar por logs e comandos, e justificar trade-offs de segurança, operação e custo.</div>",
    "nextTheme": "<p>A próxima aula compara SSL VPN, OpenVPN, WireGuard e critérios práticos de escolha.</p>"
  },
  "networkContext": {
    "osiLayers": [
      "Camada 3",
  ...
  "troubleshooting": {
    ...
    "commands": [
      ...
      {
        "platform": "Windows",
        "command": "Get-VpnConnection | Format-List *",
        "purpose": "Inspecionar perfil VPN no Windows quando aplicável.",
        "expectedObservation": "Nome do perfil, split tunneling, servidor e opções de autenticação.",
        "interpretation": "Perfil local precisa bater com a política aprovada."
      },
      {
        "platform": "IAM/VPN",
        "command": "consultar logs: usuário, dispositivo, MFA, IP origem, grupo, política e motivo de negação",
        "purpose": "Validar que decisão de acesso é auditável.",
        "expectedObservation": "Evento por usuário e política aplicada.",
        "interpretation": "Sem log por identidade, a VPN opera como caixa-preta."
      }
    ],
    "decisionTree": [
      {
  ...
  "security": {
    ...
    "vulnerabilities": [
      ...
      {
        "name": "Acesso remoto amplo demais em 10.4",
      ...
      {
        "name": "Falha de revogação em 10.4",
  ...
  "exercises": [
    ...
    },
    {
      "id": "ex10.4.p1m10.1",
      "type": "diagnóstico",
      "prompt": "Em Remote access VPN: usuário fora da rede, a sessão aparece como conectada, mas a aplicação falha. Separe hipóteses de plano de controle e plano de dados.",
  ...
  "challenge": {
    "title": "Desafio 10.4: aplicar Remote access VPN: usuário fora da rede em empresa híbrida",
  ...
  "vpnTechnicalReview": {
    ...
    "focusAreas": [
      "MFA",
      "certificados de usuário/dispositivo",
      "postura do endpoint",
  ...
  "blueTeamDetections": [
    {
      "name": "Acesso remoto anômalo em 10.4",
    ...
    {
      "name": "Tráfego excessivo ou lateral após sessão remota em 10.4",
