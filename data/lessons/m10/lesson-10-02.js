export const lesson1002 = {
  "id": "10.2",
  "moduleId": "m10",
  "order": 2,
  "title": "Tunelamento, encapsulamento e rotas",
  "subtitle": "Como um pacote privado atravessa a Internet dentro de outro pacote e por que rota errada quebra VPN.",
  "duration": "70-100 min",
  ...
  "learningOutcomes": [
    "Dado um cenário envolvendo encapsulamento, overhead, interface virtual, tabela de rotas, próximo salto, MTU e MSS, o aluno identifica requisitos, riscos e evidências.",
  ...
  "content": {
    ...
    "summary": "<ul><li><strong>Ideia central:</strong> Tunelamento é encapsular tráfego original dentro de outro protocolo para atravessar uma rede intermediária, enquanto rotas decidem quais destinos entram ou não no túnel.</li><li><strong>O que lembrar:</strong> conectividade não é autorização.</li><li><strong>Erro comum:</strong> tratar VPN como segurança automática.</li><li><strong>Uso real:</strong> home office, filiais, cloud híbrida, fornecedores e administração segura.</li></ul>\n<div class=\"evidence-box\"><strong>Resumo da revisão técnica fina:</strong> Validação técnica fina: encapsulamento, plano de controle e plano de dados. O domínio da aula exige explicar inner packet vs outer packet, route-based vs policy-based, NAT traversal, estado do túnel e tabelas internas, validar por logs e comandos, e justificar trade-offs de segurança, operação e custo.</div>",
    "nextTheme": "<p>Depois de entender túnel e rota, o próximo passo é estudar site-to-site VPN e IPsec.</p>"
  },
  "networkContext": {
    "osiLayers": [
      "Camada 3",
  ...
  "troubleshooting": {
    ...
    "commands": [
      ...
      {
        "platform": "Linux",
        "command": "ip route get 10.30.0.10 && ip xfrm state 2>/dev/null || true",
        "purpose": "Separar decisão de rota e estado IPsec quando disponível.",
        "expectedObservation": "Rota esperada e, em hosts que usam xfrm, estados/políticas IPsec.",
        "interpretation": "Rota correta sem estado de túnel indica falha de negociação ou política."
      },
      {
        "platform": "Cisco IOS",
        "command": "show crypto ikev2 sa && show crypto ipsec sa",
        "purpose": "Ver plano de controle e plano de dados IPsec.",
        "expectedObservation": "IKE SA ativa e contadores de encaps/decaps crescendo.",
        "interpretation": "IKE ativo sem IPsec decaps pode indicar seletor, rota ou firewall assimétrico."
      }
    ],
    "decisionTree": [
      {
  ...
  "security": {
    ...
    "vulnerabilities": [
      ...
      {
        "name": "Acesso remoto amplo demais em 10.2",
      ...
      {
        "name": "Falha de revogação em 10.2",
  ...
  "exercises": [
    ...
    },
    {
      "id": "ex10.2.p1m10.1",
      "type": "diagnóstico",
      "prompt": "Em Tunelamento, encapsulamento e rotas, a sessão aparece como conectada, mas a aplicação falha. Separe hipóteses de plano de controle e plano de dados.",
  ...
  "challenge": {
    "title": "Desafio 10.2: aplicar Tunelamento, encapsulamento e rotas em empresa híbrida",
  ...
  "vpnTechnicalReview": {
    "status": "aplicada",
    "focusAreas": [
      "inner packet vs outer packet",
      "route-based vs policy-based",
      "NAT traversal",
      "estado do túnel e tabelas internas"
    ],
    "validatedAgainst": [
  ...
  "blueTeamDetections": [
    {
      "name": "Acesso remoto anômalo em 10.2",
    ...
    {
      "name": "Tráfego excessivo ou lateral após sessão remota em 10.2",
