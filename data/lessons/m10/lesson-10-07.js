export const lesson1007 = {
  "id": "10.7",
  "moduleId": "m10",
  "order": 7,
  "title": "Zero Trust, ZTNA, SASE e identidade",
  "subtitle": "Por que o acesso moderno tende a proteger recursos por identidade, contexto e política, não apenas por estar dentro da rede.",
  "duration": "70-100 min",
  ...
  "learningOutcomes": [
    "Dado um cenário envolvendo Zero Trust, ZTNA, SASE, identidade, dispositivo, contexto, política adaptativa, menor privilégio e proxy de aplicação, o aluno identifica requisitos, riscos e evidências.",
  ...
  "content": {
    ...
    "summary": "<ul><li><strong>Ideia central:</strong> Zero Trust é um modelo de segurança que evita confiança implícita baseada em localização de rede; ZTNA aplica esse princípio ao acesso a aplicações e recursos.</li><li><strong>O que lembrar:</strong> conectividade não é autorização.</li><li><strong>Erro comum:</strong> tratar VPN como segurança automática.</li><li><strong>Uso real:</strong> home office, filiais, cloud híbrida, fornecedores e administração segura.</li></ul>\n<div class=\"evidence-box\"><strong>Resumo da revisão técnica fina:</strong> Validação técnica fina: Zero Trust, ZTNA e SASE como arquitetura, não marketing. O domínio da aula exige explicar NIST ZTA, policy engine, policy administrator, policy enforcement point, ZTNA por aplicação, SASE, validar por logs e comandos, e justificar trade-offs de segurança, operação e custo.</div>",
    "nextTheme": "<p>Depois de entender o modelo, vamos diagnosticar falhas comuns em VPN: rotas, MTU, DNS e firewall.</p>"
  },
  "networkContext": {
    "osiLayers": [
      "Camada 3",
  ...
  "troubleshooting": {
    ...
    "commands": [
      ...
      {
        "platform": "ZTNA/SASE",
        "command": "Matriz: app -> grupo -> condição -> ação -> log -> resposta",
        "purpose": "Modelar política por recurso, não por rede inteira.",
        "expectedObservation": "Cada aplicação tem política explícita e evidência de decisão.",
        "interpretation": "Política genérica “usuários internos podem tudo” não é Zero Trust."
      }
    ],
    "decisionTree": [
      {
  ...
  "security": {
    ...
    "vulnerabilities": [
      ...
      {
        "name": "Acesso remoto amplo demais em 10.7",
      ...
      {
        "name": "Falha de revogação em 10.7",
  ...
  "exercises": [
    ...
    },
    {
      "id": "ex10.7.p1m10.1",
      "type": "diagnóstico",
      "prompt": "Em Zero Trust, ZTNA, SASE e identidade, a sessão aparece como conectada, mas a aplicação falha. Separe hipóteses de plano de controle e plano de dados.",
  ...
  "challenge": {
    "title": "Desafio 10.7: aplicar Zero Trust, ZTNA, SASE e identidade em empresa híbrida",
  ...
  "blueTeamDetections": [
    {
      "name": "Acesso remoto anômalo em 10.7",
    ...
    {
      "name": "Tráfego excessivo ou lateral após sessão remota em 10.7",
