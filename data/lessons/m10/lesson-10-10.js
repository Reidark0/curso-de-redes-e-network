export const lesson1010 = {
  "id": "10.10",
  "moduleId": "m10",
  "order": 10,
  "title": "Revisão prática: desenhar acesso remoto seguro",
  "subtitle": "Projeto integrador do módulo: escolha entre VPN, ZTNA, bastion, private endpoint e políticas de acesso.",
  "duration": "70-100 min",
  ...
  "learningOutcomes": [
    "Dado um cenário envolvendo projeto, tomada de decisão, matriz de acesso, arquitetura híbrida, custos, riscos, validação e runbook, o aluno identifica requisitos, riscos e evidências.",
  ...
  "content": {
    ...
    "summary": "<ul><li><strong>Ideia central:</strong> Um desenho maduro de acesso remoto combina conectividade, identidade, política, segmentação, DNS, logs, operação e critérios claros de validação.</li><li><strong>O que lembrar:</strong> conectividade não é autorização.</li><li><strong>Erro comum:</strong> tratar VPN como segurança automática.</li><li><strong>Uso real:</strong> home office, filiais, cloud híbrida, fornecedores e administração segura.</li></ul>\n<div class=\"evidence-box\"><strong>Resumo da revisão técnica fina:</strong> Validação técnica fina: projeto de acesso remoto seguro avaliável. O domínio da aula exige explicar capstone de acesso remoto, rubrica, riscos residuais, FinOps, logs, roadmap VPN para ZTNA, validar por logs e comandos, e justificar trade-offs de segurança, operação e custo.</div>",
    "nextTheme": "<p>O próximo módulo aprofunda roteamento, OSPF, BGP e troubleshooting de caminhos, que são essenciais para VPN site-to-site e cloud híbrida.</p>"
  },
  "networkContext": {
    "osiLayers": [
      "Camada 3",
  ...
  "troubleshooting": {
    ...
    "commands": [
      ...
      {
        "platform": "Projeto",
        "command": "Checklist final: arquitetura, rotas, DNS, IAM, MFA, logs, custos, revogação, rollback",
        "purpose": "Garantir que o projeto cobre conectividade, segurança e operação.",
        "expectedObservation": "Todos os itens têm evidência e responsável.",
        "interpretation": "Item sem evidência não deve contar como atendido."
      }
    ],
    "decisionTree": [
      {
  ...
  "security": {
    ...
    "vulnerabilities": [
      ...
      {
        "name": "Acesso remoto amplo demais em 10.10",
      ...
      {
        "name": "Falha de revogação em 10.10",
  ...
  "lab": {
    "id": "lab-10.10",
    "title": "Projeto final do Módulo 10 — Acesso remoto seguro",
    "labType": "security",
    "objective": "Produzir uma arquitetura completa para usuários, administradores, fornecedores e integração cloud híbrida.",
    "scenario": "Você atua como analista de infraestrutura e segurança. A empresa precisa lidar com projeto, tomada de decisão, matriz de acesso, arquitetura híbrida, custos, riscos, validação e runbook sem expor recursos internos diretamente na Internet.",
    ...
    "tools": [
      ...
      "Planilha",
      "Editor de texto",
      "Opcional: Packet Tracer/GNS3 para simular segmentos"
    ],
    ...
    "steps": [
      ...
      },
      {
        ...
        "instruction": "Entregar capstone completo com diagrama, matriz de acesso, runbook, plano de logs, custos e defesa técnica.",
        "command": "# Dossiê M10 10.10\nTema: Revisão prática: desenhar acesso remoto seguro\nFoco: capstone de acesso remoto | rubrica | riscos residuais | FinOps | logs | roadmap VPN para ZTNA\nEntregável: matriz técnica com decisão, evidência e risco residual",
  ...
  "exercises": [
    ...
    },
    {
      "id": "ex10.10.p1m10.1",
      "type": "diagnóstico",
      "prompt": "Em Revisão prática: desenhar acesso remoto seguro, a sessão aparece como conectada, mas a aplicação falha. Separe hipóteses de plano de controle e plano de dados.",
  ...
  "challenge": {
    "title": "Desafio 10.10: aplicar Revisão prática: desenhar acesso remoto seguro em empresa híbrida",
  ...
  "references": [
    ...
    },
    {
      ...
      "note": "Referência para explicar que Zero Trust desloca o foco de perímetros estáticos de rede para usuários, ativos e recursos."
    },
    {
      "type": "official-doc",
      "title": "Cloudflare One - SASE and Zero Trust overview",
      "organization": "Cloudflare",
      "url": "https://developers.cloudflare.com/cloudflare-one/",
      "note": "Referência moderna para SASE como modelo que une serviços de rede corporativa com segurança Zero Trust."
    },
    {
      "type": "official-doc",
  ...
  "vpnTechnicalReview": {
    "status": "aplicada",
    "focusAreas": [
      "capstone de acesso remoto",
      "rubrica",
      "riscos residuais",
      "FinOps",
      "logs",
      "roadmap VPN para ZTNA"
    ],
    "validatedAgainst": [
      "NIST SP 800-207 - Zero Trust Architecture",
      "Cloudflare One - SASE and Zero Trust overview",
  ...
  "blueTeamDetections": [
    {
      "name": "Acesso remoto anômalo em 10.10",
    ...
    {
      "name": "Tráfego excessivo ou lateral após sessão remota em 10.10",
