export const lesson1005 = {
  "id": "10.5",
  "moduleId": "m10",
  "order": 5,
  "title": "SSL VPN, OpenVPN, WireGuard e escolhas práticas",
  "subtitle": "Comparando tecnologias de acesso remoto por protocolo, operação, compatibilidade, desempenho e governança.",
  "duration": "70-100 min",
  ...
  "learningOutcomes": [
    "Dado um cenário envolvendo TLS, OpenVPN, WireGuard, IPsec client VPN, compatibilidade, UDP/TCP, chaves, certificados e operação, o aluno identifica requisitos, riscos e evidências.",
  ...
  "content": {
    ...
    "summary": "<ul><li><strong>Ideia central:</strong> Diferentes tecnologias de VPN resolvem o mesmo problema com modelos operacionais diferentes; a escolha depende de segurança, suporte, identidade, logs, desempenho e maturidade da equipe.</li><li><strong>O que lembrar:</strong> conectividade não é autorização.</li><li><strong>Erro comum:</strong> tratar VPN como segurança automática.</li><li><strong>Uso real:</strong> home office, filiais, cloud híbrida, fornecedores e administração segura.</li></ul>\n<div class=\"evidence-box\"><strong>Resumo da revisão técnica fina:</strong> Validação técnica fina: SSL VPN, OpenVPN e WireGuard sem fanatismo de ferramenta. O domínio da aula exige explicar OpenVPN SSL/TLS TCP/UDP, WireGuard UDP e cryptokey routing, AllowedIPs, gestão de chaves, mobilidade e NAT, validar por logs e comandos, e justificar trade-offs de segurança, operação e custo.</div>",
    "nextTheme": "<p>Depois da tecnologia do túnel, vamos estudar o que passa por ele: split tunnel, full tunnel e DNS.</p>"
  },
  "networkContext": {
    "osiLayers": [
      "Camada 3",
  ...
  "troubleshooting": {
    ...
    "commands": [
      ...
      {
        "platform": "WireGuard/Linux",
        "command": "wg show",
        "purpose": "Ver peers, handshake recente, transferência e AllowedIPs.",
        "expectedObservation": "Handshake recente e bytes crescendo para o peer esperado.",
        "interpretation": "Sem handshake recente pode haver bloqueio UDP, chave incorreta, endpoint errado ou keepalive ausente."
      },
      {
        "platform": "OpenVPN",
        "command": "openvpn --config cliente.ovpn --verb 4",
        "purpose": "Observar negociação TLS e instalação de rotas em ambiente de laboratório autorizado.",
        "expectedObservation": "TLS handshake, PUSH_REPLY e rotas/DNS aplicados.",
        "interpretation": "Erro TLS difere de erro de rota; separar autenticação de alcançabilidade."
      }
    ],
    "decisionTree": [
      {
  ...
  "security": {
    ...
    "vulnerabilities": [
      ...
      {
        "name": "Acesso remoto amplo demais em 10.5",
      ...
      {
        "name": "Falha de revogação em 10.5",
  ...
  "exercises": [
    ...
    },
    {
      "id": "ex10.5.p1m10.1",
      "type": "diagnóstico",
      "prompt": "Em SSL VPN, OpenVPN, WireGuard e escolhas práticas, a sessão aparece como conectada, mas a aplicação falha. Separe hipóteses de plano de controle e plano de dados.",
  ...
  "challenge": {
    "title": "Desafio 10.5: aplicar SSL VPN, OpenVPN, WireGuard e escolhas práticas em empresa híbrida",
  ...
  "references": [
    ...
    },
    {
      ...
      "note": "Referência para explicar OpenVPN como daemon flexível com SSL/TLS, bridging, transporte TCP/UDP, NAT e DHCP."
    },
    {
      "type": "official-doc",
      "title": "WireGuard - Cryptokey Routing and Protocol",
      "organization": "WireGuard",
      "url": "https://www.wireguard.com/",
      "note": "Referência para explicar peers, chaves públicas, AllowedIPs, roteamento por chave e operação UDP."
    }
  ],
  "linksToOtherCourses": [
    {
  ...
  "vpnTechnicalReview": {
    "status": "aplicada",
    "focusAreas": [
      "OpenVPN SSL/TLS TCP/UDP",
      "WireGuard UDP e cryptokey routing",
      "AllowedIPs",
      "gestão de chaves",
      "mobilidade e NAT"
    ],
    "validatedAgainst": [
      "OpenVPN 2.6 Manual",
      "WireGuard - Cryptokey Routing and Protocol"
    ],
    "decisionMatrix": [
      {
  ...
  "blueTeamDetections": [
    {
      "name": "Acesso remoto anômalo em 10.5",
    ...
    {
      "name": "Tráfego excessivo ou lateral após sessão remota em 10.5",
