export const lesson1003 = {
  "id": "10.3",
  "moduleId": "m10",
  "order": 3,
  "title": "Site-to-site VPN e IPsec na prática",
  "subtitle": "Como duas redes privadas se conectam com negociação criptográfica, seletores de tráfego e políticas de firewall.",
  "duration": "70-100 min",
  ...
  "learningOutcomes": [
    "Dado um cenário envolvendo IPsec, IKE, fases de negociação, Security Associations, crypto map, route-based VPN e policy-based VPN, o aluno identifica requisitos, riscos e evidências.",
  ...
  "content": {
    ...
    "summary": "<ul><li><strong>Ideia central:</strong> Site-to-site VPN conecta redes inteiras por gateways, normalmente usando IPsec para autenticar pares, negociar chaves e proteger tráfego entre sub-redes autorizadas.</li><li><strong>O que lembrar:</strong> conectividade não é autorização.</li><li><strong>Erro comum:</strong> tratar VPN como segurança automática.</li><li><strong>Uso real:</strong> home office, filiais, cloud híbrida, fornecedores e administração segura.</li></ul>\n<div class=\"evidence-box\"><strong>Resumo da revisão técnica fina:</strong> Validação técnica fina: IPsec/IKEv2, Security Associations e seletores. O domínio da aula exige explicar IKEv2, Security Associations, PSK vs certificados, NAT-T UDP 4500, route-based vs policy-based, PFS e lifetimes, validar por logs e comandos, e justificar trade-offs de segurança, operação e custo.</div>",
    "nextTheme": "<p>Depois de conectar redes inteiras, vamos estudar o caso oposto: um usuário individual fora da rede.</p>"
  },
  "networkContext": {
    "osiLayers": [
      "Camada 3",
  ...
  "troubleshooting": {
    ...
    "commands": [
      ...
      },
      {
        ...
        "purpose": "Ver negociação, SAs e seletores/ACLs criptográficos.",
        "expectedObservation": "IKE ativo, IPsec SAs instaladas e contadores de encaps/decaps crescendo.",
        "interpretation": "Contador só de encaps sugere problema de retorno, seletor ou firewall remoto."
      },
      {
        "platform": "Firewall/Cloud",
        "command": "verificar logs de IKE, IPsec, NAT-T, DPD e BGP/rotas do túnel",
        "purpose": "Correlacionar túnel com rota e estado.",
        "expectedObservation": "Eventos de up/down, bytes, pares e rotas anunciadas.",
        "interpretation": "Túnel up sem rota é conectividade criptográfica sem alcançabilidade."
      }
    ],
    "decisionTree": [
      {
  ...
  "security": {
    ...
    "vulnerabilities": [
      ...
      {
        "name": "Acesso remoto amplo demais em 10.3",
      ...
      {
        "name": "Falha de revogação em 10.3",
  ...
  "lab": {
    "id": "lab-10.3",
    "title": "Desenhando uma VPN site-to-site entre matriz e filial",
    "labType": "security",
    "objective": "Planejar sub-redes, gateways, seletores, regras de firewall, logs e validação de uma VPN entre dois sites.",
    "scenario": "Você atua como analista de infraestrutura e segurança. A empresa precisa lidar com IPsec, IKE, fases de negociação, Security Associations, crypto map, route-based VPN e policy-based VPN sem expor recursos internos diretamente na Internet.",
    ...
    "tools": [
      "Cisco Packet Tracer ou GNS3 opcional",
      "Editor de diagrama",
    ...
    "steps": [
      ...
      },
      {
        ...
        "instruction": "Validar uma VPN site-to-site como dossiê: proposals, identidade, seletores, rotas, NAT-T, contadores e logs.",
        "command": "# Dossiê M10 10.3\nTema: Site-to-site VPN e IPsec na prática\nFoco: IKEv2 | Security Associations | PSK vs certificados | NAT-T UDP 4500 | route-based vs policy-based | PFS e lifetimes\nEntregável: matriz técnica com decisão, evidência e risco residual",
  ...
  "exercises": [
    ...
    },
    {
      "id": "ex10.3.p1m10.1",
      "type": "diagnóstico",
      "prompt": "Em Site-to-site VPN e IPsec na prática, a sessão aparece como conectada, mas a aplicação falha. Separe hipóteses de plano de controle e plano de dados.",
  ...
  "challenge": {
    "title": "Desafio 10.3: aplicar Site-to-site VPN e IPsec na prática em empresa híbrida",
  ...
  "references": [
    ...
    },
    {
      ...
      "note": "Base técnica para explicar IKEv2, autenticação mútua e estabelecimento/manutenção de Security Associations em IPsec."
    },
    {
      "type": "rfc",
      "title": "RFC 8247 - Algorithm Implementation Requirements and Usage Guidance for IKEv2",
      "organization": "IETF",
      "url": "https://www.rfc-editor.org/info/rfc8247",
      "note": "Referência para cautela com algoritmos, suites criptográficas e obsolescência em ambientes IPsec/IKEv2."
    },
    {
      "type": "official-doc",
  ...
  "blueTeamDetections": [
    {
      "name": "Acesso remoto anômalo em 10.3",
    ...
    {
      "name": "Tráfego excessivo ou lateral após sessão remota em 10.3",
