export const lesson1001 = {
  "id": "10.1",
  "moduleId": "m10",
  "order": 1,
  "title": "Por que VPN, túneis e acesso remoto existem",
  "subtitle": "O problema de acessar recursos privados por redes públicas sem transformar a rede interna em uma porta aberta.",
  "duration": "70-100 min",
  ...
  "learningOutcomes": [
    "Dado um cenário envolvendo motivação, perímetro, home office, filiais, fornecedores e superfície de ataque, o aluno identifica requisitos, riscos e evidências.",
  ...
  "content": {
    ...
    "summary": "<ul><li><strong>Ideia central:</strong> VPN e acesso remoto seguro são formas de criar um caminho controlado até recursos privados usando autenticação, criptografia, rotas, DNS, políticas e logs.</li><li><strong>O que lembrar:</strong> conectividade não é autorização.</li><li><strong>Erro comum:</strong> tratar VPN como segurança automática.</li><li><strong>Uso real:</strong> home office, filiais, cloud híbrida, fornecedores e administração segura.</li></ul>\n<div class=\"evidence-box\"><strong>Resumo da revisão técnica fina:</strong> Validação técnica fina: por que VPN não é sinônimo de segurança. O domínio da aula exige explicar diferença entre conectividade e autorização, perímetro vs recurso, VPN, ZTNA, bastion e private endpoint, inventário e escopo mínimo, validar por logs e comandos, e justificar trade-offs de segurança, operação e custo.</div>",
    "nextTheme": "<p>Na próxima aula, você verá o mecanismo que torna isso possível: tunelamento, encapsulamento e rotas.</p>"
  },
  "networkContext": {
    "osiLayers": [
      "Camada 3",
  ...
  "troubleshooting": {
    ...
    "commands": [
      ...
      {
        "platform": "Arquitetura",
        "command": "Matriz: usuário/grupo -> recurso -> método -> justificativa -> evidência",
        "purpose": "Evitar solução baseada em ferramenta antes de mapear necessidade real.",
        "expectedObservation": "Cada acesso tem dono, recurso, método, risco e evidência.",
        "interpretation": "Sem matriz, a VPN tende a virar rede plana remota."
      }
    ],
    "decisionTree": [
      {
  ...
  "security": {
    ...
    "vulnerabilities": [
      ...
      {
        "name": "Acesso remoto amplo demais em 10.1",
      ...
      {
        "name": "Falha de revogação em 10.1",
  ...
  "exercises": [
    ...
    },
    {
      "id": "ex10.1.p1m10.1",
      "type": "diagnóstico",
      "prompt": "Em Por que VPN, túneis e acesso remoto existem, a sessão aparece como conectada, mas a aplicação falha. Separe hipóteses de plano de controle e plano de dados.",
  ...
  "challenge": {
    "title": "Desafio 10.1: aplicar Por que VPN, túneis e acesso remoto existem em empresa híbrida",
  ...
  "vpnTechnicalReview": {
    "status": "aplicada",
    "focusAreas": [
      "diferença entre conectividade e autorização",
      "perímetro vs recurso",
      "VPN, ZTNA, bastion e private endpoint",
      "inventário e escopo mínimo"
    ],
    "validatedAgainst": [
  ...
  "blueTeamDetections": [
    {
      "name": "Acesso remoto anômalo em 10.1",
    ...
    {
      "name": "Tráfego excessivo ou lateral após sessão remota em 10.1",
